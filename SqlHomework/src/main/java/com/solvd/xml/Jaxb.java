...
public class Jaxb {
    ...
    public static void UnmarshallExample() throws JAXBException {
        ...
        Car car = (Car) jaxbUnmarshaller.unmarshal( new File("marshalled_car.xml") );
    ...
    public static void marshallExample() throws JAXBException {
        ...
        jaxbMarshaller.marshal(car, new File("marshalled_car.xml"));
    }
    ...
    public static void UnmarshallListExample() throws JAXBException {
        ...
        Cars cars = (Cars) jaxbUnmarshaller.unmarshal( new File("marshalled_carList.xml") );
    ...
    public static void marshalListExample() throws JAXBException {
        ...
        //Marshal the cars list in file
        jaxbMarshaller.marshal(cars, new File("marshalled_carList.xml"));
    }
}